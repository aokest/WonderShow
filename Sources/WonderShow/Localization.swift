        ...
        case .zhHans:
            return AppCopy(
                ...
                strings: [
                    ...
                    "waitingConnection": "等待连接", "accessPerm": "辅助功能", "cameraPerm": "摄像头权限", "chromeAuto": "Chrome 自动化",
                    "scanSummary": "扫描摘要", "examples": "兼容示例", "permBtn": "辅助功能设置", "requestBtn": "辅助功能授权",
                    "cameraPermBtn": "摄像头权限", "cameraPermissionDeniedHint": "请在系统设置中允许灵演访问摄像头。",
                    "permissionGranted": "已授权", "permissionNeeded": "需要授权", "permissionDenied": "已拒绝",
                    "permissionRestricted": "受限制", "permissionUnknown": "未检测",
                    ...
                    "sourceSlotConflictTitle": "源位已被占用", "sourceSlotConflictBody": "已绑定到",
                    "presenterVideoEffects": "讲者画面", "mirrorPresenter": "镜像",
                    "presenterBrightness": "亮度", "presenterContrast": "对比", "presenterBeauty": "柔化",
                    "presenterSmartBeauty": "智能美颜", "presenterNaturalBeauty": "自然美颜",
                    "presenterBeautyStyle": "风格", "presenterBeautyNatural": "自然",
                    "presenterBeautyClean": "清透", "presenterBeautyBright": "明亮",
                    "presenterBeautyCameraReady": "上镜", "presenterSkinSmoothing": "磨皮",
                    "presenterSkinBrightening": "提亮", "presenterSkinWhitening": "净肤",
                    "presenterBlemishReduction": "祛瑕", "presenterComplexion": "气色",
                    "presenterBeautyHelp": "只对检测到的讲者脸部和颈部做自然美化",
        ...
        case .zhHant:
            return AppCopy(
                ...
                strings: [
                    ...
                    "waitingConnection": "等待連接", "accessPerm": "輔助使用", "cameraPerm": "攝影機權限", "chromeAuto": "Chrome 自動化",
                    "scanSummary": "掃描摘要", "examples": "兼容範例", "permBtn": "輔助使用設定", "requestBtn": "輔助使用授權",
                    "cameraPermBtn": "攝影機權限", "cameraPermissionDeniedHint": "請在系統設定中允許靈演存取攝影機。",
                    "permissionGranted": "已授權", "permissionNeeded": "需要授權", "permissionDenied": "已拒絕",
                    "permissionRestricted": "受限制", "permissionUnknown": "未偵測",
                    ...
                    "sourceTierSlots": "可用源位", "sourceSlotLocked": "不可使用源位",
                    "sourceSlotConflictTitle": "源位已被佔用", "sourceSlotConflictBody": "已綁定到",
                    "presenterVideoEffects": "講者畫面", "mirrorPresenter": "鏡像",
                    "presenterBrightness": "亮度", "presenterContrast": "對比", "presenterBeauty": "柔化",
                    "presenterSmartBeauty": "智能美顏", "presenterNaturalBeauty": "自然美顏",
                    "presenterBeautyStyle": "風格", "presenterBeautyNatural": "自然",
                    "presenterBeautyClean": "清透", "presenterBeautyBright": "明亮",
                    "presenterBeautyCameraReady": "上鏡", "presenterSkinSmoothing": "磨皮",
                    "presenterSkinBrightening": "提亮", "presenterSkinWhitening": "淨膚",
                    "presenterBlemishReduction": "祛瑕", "presenterComplexion": "氣色",
                    "presenterBeautyHelp": "只對檢測到的講者臉部和頸部做自然美化",
        ...
        case .en:
            return AppCopy(
                ...
                strings: [
                    ...
                    "waitingConnection": "Waiting", "accessPerm": "Accessibility", "cameraPerm": "Camera Access", "chromeAuto": "Chrome Automation",
                    "scanSummary": "Scan Summary", "examples": "Supported", "permBtn": "Accessibility Settings", "requestBtn": "Accessibility Access",
                    "cameraPermBtn": "Camera Access", "cameraPermissionDeniedHint": "Allow WonderShow to access the camera in System Settings.",
                    "permissionGranted": "Granted", "permissionNeeded": "Needs Access", "permissionDenied": "Denied",
                    "permissionRestricted": "Restricted", "permissionUnknown": "Unknown",
                    ...
                    "sourceSlotConflictTitle": "Slot already used", "sourceSlotConflictBody": "is already assigned to",
                    ...
                    "presenterSmartBeauty": "Smart Beauty", "presenterNaturalBeauty": "Natural",
                    "presenterBeautyStyle": "Style", "presenterBeautyNatural": "Natural",
                    "presenterBeautyClean": "Clean", "presenterBeautyBright": "Bright",
                    "presenterBeautyCameraReady": "Camera", "presenterSkinSmoothing": "Smooth",
                    "presenterSkinBrightening": "Lift", "presenterSkinWhitening": "Cleanse",
                    "presenterBlemishReduction": "Blemish", "presenterComplexion": "Tone",
                    "presenterBeautyHelp": "Applies natural touch-up only to detected face and neck areas",
